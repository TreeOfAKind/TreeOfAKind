...
namespace TreeOfAKind.API.UserProfiles
{
    ...
    public class UserProfileController : Controller
    {
        ...
        /// </summary>
        /// <returns>User profile of an authenticated user</returns>
        /// <response code="200">Returns user profile</response>
        /// <response code="401">User is not authenticated</response>
        /// <response code="404">User profile has not been created</response>
        [HttpPost]
        [Authorize]
        ...
        public async Task<IActionResult> GetMyUserProfile()
        {
            ...
            return user is null ?  (IActionResult) NotFound() : Ok(user);
        }
    }
}